...
# kubevirt.io/vm-file-restore-operator-bundle:$VERSION and kubevirt.io/vm-file-restore-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kubevirt.io/vm-file-restore-operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx rm vm-file-restore-operator-builder
	rm Dockerfile.cross
...
$(GOLANGCI_LINT): $(LOCALBIN)
	GOTOOLCHAIN=go1.26.0 go install github.com/golangci/golangci-lint/v2/cmd/golangci-lint@$(GOLANGCI_LINT_VERSION)
	mv $(shell go env GOPATH)/bin/golangci-lint $(GOLANGCI_LINT)
